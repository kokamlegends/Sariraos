<?php 
	...
	if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
		...
		$cartOutput = "<h3 style=' text-align: center; font-weight: lighter; padding: 10px 0px; background: #ffeeee; color: #333;'>Tidak ada pesanan di keranjang anda</h3>";
...
<div class="content remove_pad" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class=>Keranjang pesanan</span></h2>
...
<div class="overlay" id="overlay" onclick="hide_overlay()"></div>
	...
	<div class="info_holder">
		...
		<h2><span class=>Complete Your Order</span></h2>
		...
		<form method="post" action="" onSubmit="validate_input(); return false">
			...
			<div class="form_group">
				...
				<div class="form_group">
					...
					<label>Name</label>
					<input value="<?= $name ?>" type="text" id="name" name="name" placeholder="Enter your full name" readonly>
				...
				<div class="form_group">
					...
					<label>Code BK</label>
					<input value="<?= "BK_".$_SESSION['id']; ?>" type="text" id="addr"  name="addr" placeholder="Enter your code BK" readonly>
				...
				<div class="form_group">
					...
					<label>Email</label>
					<input value="<?= $email_cust ?>" type="Email" id="email" name="email" placeholder="Enter your email" readonly>
				...
				<div class="form_group">
					...
					<input value="<?= $contact_number ?>" type="text" id="phone" name="phone" placeholder="Enter your phone number" readonly>
				...
				<div class="form_group">
					...
					?>
					<input type="hidden" name="reserve_id" id="reserve_id" value="<?=$_SESSION['id']?>">
