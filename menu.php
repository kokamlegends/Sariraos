<?php 
	...
	if($get_recent->num_rows) {
		...
		while($row = $get_recent->fetch_assoc()) {
			...
			if($row['food_category'] == "Makanan") {
			...
			}elseif($row['food_category'] == "Minuman") {
				...
				$lunch .=	"<div class='parallax_item'>
					...
					}elseif($row['food_category'] == "Minuman2") {
...
<div class="alert">
	<?php 
	$reserve_code = "BK_".$_SESSION['id'];
		echo $msg = "<p style='padding: 15px; color: green; background: #eeffee; font-weight: bold; font-size: 13px; border-radius: 4px; text-align: center;'>Booking berhasil dilakukan. Kode Booking Anda adalah  $reserve_code. Harap dicatat </p>";
	?>
</div>
...
<div class="content" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="Makanan">Menu Makanan</span></h2>
...
<div class="content" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="Minuman">Menu Minuman</span></h2>
